CREATE TABLE `user_api_tokens` (
  ...
  `date_created` timestamp NOT NULL DEFAULT current_timestamp() COMMENT 'Time the API token was created',
  `date_last_used` timestamp NULL DEFAULT NULL COMMENT 'Time the API token was last used',
