...
class UserAPITokensController extends AbstractBaseController {
    constructor(model) {
        ...
        this.createdTokenElm = document.createElement('div');
        this.tokensElm = document.createElement('div');
        ...
        this.createForm.addEventListener('submit', (event) => __awaiter(this, void 0, void 0, function* () {
    ...
    createToken() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.setMessage('');
            try {
                const token = yield this.model.createToken(description);
    ...
    render() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let tokens;
            try {
                tokens = yield this.model.getTokens();
            }
            catch (error) {
                this.setMessage(this.errorMessage(error));
                return;
            ...
            for (const token of tokens) {
                ...
                revokeButton.addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
    ...
    deleteToken(token) {
        return __awaiter(this, void 0, void 0, function* () {
            this.setMessage('');
            try {
                yield this.model.deleteToken(token);
            }
            catch (error) {
                this.setMessage(this.errorMessage(error));
            }
...
class UserAPITokensModel {
    constructor(tokensApi) {
        ...
        this.tokenEventEmitter = new EventEmitter();
        this.tokens = [];
        this.loaded = false;
    }
    getTokens() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.loaded) {
                this.tokens = yield this.tokensApi.getTokens();
                this.loaded = true;
            }
            return this.tokens;
        });
    ...
    createToken(description) {
        return __awaiter(this, void 0, void 0, function* () {
            const created = yield this.tokensApi.createToken(description);
            const token = {
    ...
    deleteToken(token) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.tokensApi.deleteToken(token);
