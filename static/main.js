...
function Dashboard(elm) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const env = yield (new EnvApi()).getEnv();
...
function Shields({ env }) {
    ...
    const createShield = () => __awaiter(this, void 0, void 0, function* () {
        setError("");
        try {
            const shield = yield api.saveShield({
                Name: "New Shield",
                Title: "New",
                Color: "00AA55",
                Text: "Shield",
    ...
    const saveShield = (shield) => __awaiter(this, void 0, void 0, function* () {
        setError("");
        try {
            const savedShield = yield api.saveShield(shield);
    ...
    const deleteShield = (shield) => __awaiter(this, void 0, void 0, function* () {
        setError("");
        try {
            yield api.deleteShield(shield);
...
function ShieldForm({ shield, env, onSave, onDelete }) {
    ...
    const handleInput = (event) => {
        ...
        switch (input.name) {
            ...
            case "Text":
                ...
                break;
            case "Color":
                next = Object.assign(Object.assign({}, draftRef.current), { Color: input.value.replace(/^#/, "") });
                break;
            default:
                return;
        }
    ...
    const deleteShield = () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield onDelete(draftRef.current);
    });
...
function APITokens() {
    ...
    const createToken = (event) => __awaiter(this, void 0, void 0, function* () {
        ...
        setError("");
        try {
            const token = yield api.createToken(trimmedDescription);
    ...
    const revokeToken = (token) => __awaiter(this, void 0, void 0, function* () {
        if (!confirm(`Revoke the token “${token.Description}”? This cannot be undone.`)) {
            return;
        }
        setError("");
        try {
            yield api.deleteToken(token);
