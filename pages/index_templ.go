...
func IndexPage(hosts Hosts) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 15, "</li></ul></div></article></section><section><article class=\"static-badge-generator\"><h3>Static Badge Generator</h3><p>Create a fixed README badge by choosing its title, text, and color.</p><div id=\"static-badge-generator\"></div></article></section><section><article class=\"api-examples\"><h3>API examples</h3><div id=\"api-example\"></div><p><a href=\"/api.html\">Read the full API docs</a></p></article></section><section><article class=\"open-source\"><h3>Open Source</h3><p>Interested in reviewing the code or hosting your own instance? The complete source is available on GitHub.</p><p>Visit <a href=\"https://github.com/shieldedDotDev/\">Shielded.dev on GitHub</a> to learn more.</p><p>Shielded.dev is built with Go and TypeScript using a MySQL database.</p></article></section></main><script type=\"module\">\n\t\t\t\timport { Home } from '/main.js';\n\n\t\t\t\tdocument.addEventListener('DOMContentLoaded', function () {\n\t\t\t\t\tHome(document.getElementById('api-example'), document.getElementById('static-badge-generator'));\n\t\t\t\t});\n\t\t\t</script>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
